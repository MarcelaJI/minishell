...
void				copy_full_word(char *input, char *str, size_t *a,
						size_t *b);
...
/*  QUOTES  */
void				update_double_quote_flag(char *str, int *dquote,
						int *squote, size_t *i);
void				update_single_quote_flag(char *str, int *squote,
						int *dquote, size_t *i);
void				skip_quoted_single_block(char *str, int *dquote,
						int *squote, size_t *i);
...
void				check_memory_failure(t_data *data, void *ptr, char **dptr,
						int f);
...
int					open_outfile(t_data *data, t_dlist *node, int out_fd,
						int apd);
int					open_infile(t_data *data, t_dlist *node, int in_fd);
void				open_files_extension(t_data *data, int in_fd, int out_fd,
						int n);
